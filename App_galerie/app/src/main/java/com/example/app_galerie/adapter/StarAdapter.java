package com.example.app_galerie.adapter;
...
import com.example.app_galerie.R;
                ...
                AlertDialog dialog = new AlertDialog.Builder(holder.itemView.getContext())
                        ...
                        .setPositiveButton("Validate", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                // Vérification si l'objet star n'est pas nul
                                ...
                                if (star != null) {
                                    ...
                                    Log.e(TAG, "Star object is null for id: " + ids);
                                }
                            }
                        })
